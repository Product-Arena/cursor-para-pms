...
Isso normalmente acontece quando o `git clone` está usando o endereço SSH (`git@github.com:...`) em vez de HTTPS.

*Solução:* use HTTPS. Peça ao Cursor: "Deu erro de permissão. Me ajude a clonar usando HTTPS (https://github.com/...) em vez de SSH".

**Erro: "git command not found"**
Você não tem o Git instalado.
*Solução:* Peça ao Cursor: "Como instalo o Git no [seu sistema operacional]?"

**Onde a pasta foi salva?**
Ela será criada dentro da pasta raiz que você abriu no Cursor.
