...
- Git configurado (HTTPS + login, ou `gh auth login`).
...
Faça login com `gh auth login` (GitHub CLI) ou tente novamente o push via HTTPS (o GitHub abre autenticação no navegador).
