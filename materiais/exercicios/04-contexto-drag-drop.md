# Exercício 04: Contexto via Drag & Drop (Modo Ask)

**Objetivo:** Aprender a alimentar a IA com o contexto específico que você quer analisar.
...
5.  Digite o prompt:
    ```text
    "O que essa pasta faz? Me dê um resumo do propósito desse repositório."
    ```
...
![GIF: Arrastando pasta para o contexto](../apresentacao/assets/ask-context.gif)
