# Exercícios — Cursor para PMs

Exercícios práticos do curso, organizados por bloco.

## Arena Voting System (Bloco 3)

O documento de requisitos do Arena Voting System está em **[arthur-request.md](arthur-request.md)** — requisitos do produto (tópicos, votação, ranking, duas interações). Use como input para o command `/create-prd`.
...
| 13 | [13-projeto-final-parte5-refinamento.md](13-projeto-final-parte5-refinamento.md) | 3 | Arena Voting — Refinamento |
| 14 | [14-prototipo-funcional-localhost.md](14-prototipo-funcional-localhost.md) | 3–4 | Protótipo funcional em localhost |
| 15 | [15-github-subir-projeto.md](15-github-subir-projeto.md) | 3 | Subir projeto Arena Voting no GitHub pessoal |
